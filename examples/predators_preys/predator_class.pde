class Predators extends Boids{
  public Predators(int _population, float body_size, color body_color, float body_weight, float sensor_radius, float fixed_speed){
